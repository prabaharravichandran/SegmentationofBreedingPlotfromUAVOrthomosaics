...
DJANGO_DB_MONGODB = 'mongodb'

# Default database to use (unless overridden by DJANGO_DB env variable)
...
# By default, we assign PostgreSQL as the default database.
DATABASES_ALL['default'] = DATABASES_ALL[DJANGO_DB_POSTGRESQL]

# The final DATABASES setting picks the configuration based on the DJANGO_DB env variable.
